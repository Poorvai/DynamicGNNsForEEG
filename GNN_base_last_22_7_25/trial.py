...
from model_1Dconv import EEGGraphModel
import random 
...
interictal_path = preictal_path = '/Users/poorvaichandrasen/GCN_IIST/Patient_2'
max_train_file = 10
max_val_file = 4
window = 25000
...
print('Device = ', device)
set_seed(0)
model_1 = EEGGraphModel(input_timesteps=window,
                         cnn_out_dim=6 , gnn_hidden_dim= 12).to(device)
...
for epoch in range(epochs):
    ...
    if val_acc_1 > best_val_acc:
        ...
        epochs_since_improvement = 0
        save_path = "/Users/poorvaichandrasen/Downloads/1DConv.pth"
